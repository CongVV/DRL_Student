...
public abstract class AppUrl {
    ...
    public static final String URL_GET_SCHOOL_LIST                  = URL_APP_BASE + "getdataschool.php";
    ...
    public static final String URL_GET_ACTIVITY_GROUP_LIST          = URL_APP_BASE + "getdataactivitygrouplist.php";
